...
if plot_figures == 'yes':
    ...
    print('')  
    print('---  CARS Plot Elapsed time in seconds = {0}     ---'.format(total_run))
    print('---  CARS Plot Elapsed time in minutes = {0}     ---'.format(total_run/60))
    print('---  CARS Plot Elapsed time in   hours = {0}     ---'.format(total_run/3600))    
    print('')
    print('******************************************************************')
